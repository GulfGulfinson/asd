          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600 mb-1">
              {userStats.averageQuizScore >= 60 ? 
                Math.round((userStats.totalQuizzesPassed / Math.max(1, userStats.totalQuizzesPassed + 1)) * 100) : 
                0}%
            </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
              <div className="flex items-center mb-2">
                ...
                <span className="text-sm font-medium text-green-800">Bestanden</span>
              </div>
              <div className="text-lg font-bold text-green-900">
                {userStats.totalQuizzesPassed} Quiz
              </div>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
              <div className="flex items-center mb-2">
                ...
                <span className="text-sm font-medium text-blue-800">Beste Leistung</span>
              </div>
              <div className="text-lg font-bold text-blue-900">
                {userStats.highestQuizScore > 0 ? `${userStats.highestQuizScore}%` : '0%'}
              </div>
            </div>
            ...
            <div className="p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-100">
              <div className="flex items-center mb-2">
                ...
                <span className="text-sm font-medium text-purple-800">Gesamtzeit</span>
              </div>
